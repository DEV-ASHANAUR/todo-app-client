...
const Home = () => {
    ...
    const handleForm = (e) => {
        ...
        axois.post('https://shielded-scrubland-08663.herokuapp.com/todo',{
            item : name,
            status : false
        }).then(result=>{
    ...
    const handleUpdate = (e) =>{
        ...
        axios.put(`https://shielded-scrubland-08663.herokuapp.com/todo/${uitem._id}`,uitem)
        .then(res=>{
    ...
    const handleStatus = (id) => {
        ...
        if(selectedItem.status === true){
            ...
            axios.put(`https://shielded-scrubland-08663.herokuapp.com/todo/${id}`,selectedItem)
            .then(res=>{
                if(res.data.modifiedCount > 0){
                    toast('pending');
                }
            ...
            buttons: [
              {
                label: 'Yes',
                onClick: () => {
                    axios.delete(`https://shielded-scrubland-08663.herokuapp.com/todo/${id}`)
                    .then(res=>{
                        if(res.status === 200){
